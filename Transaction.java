...
public class Transaction {
	...
	Car aCar; //from the Customer class in same directory
	...
	private int birthDate, birthYear;
...
////////////////////////////////////////////save all data to .txt file for the Owner//////////////////////////////
	...
	PrintWriter outFile = new PrintWriter(new FileOutputStream(new File("Transactions_Inventory.txt"), true));
		...
		outFile.printf("Total Rent Price: %.2f", + aCar.getRentalPrice(this));
		outFile.println(" ");
		outFile.println("--------------------------------------------------");
        outFile.close();
     }
